...
dependencies {
    ...
    implementation 'com.senspark.ee:facebook-ads:2.7.0'
    implementation 'com.senspark.ee:iron-source-mediation:2.7.0'
...
pod 'ee-x/facebook-ads', '2.7.0'
pod 'ee-x/iron-source-mediation', '2.7.0'
