...
```java
dependencies {
    implementation 'com.senspark.ee:ad-mob-mediation:2.6.0'
    implementation 'com.senspark.ee:facebook-ads:2.6.0'
    implementation 'com.senspark.ee:iron-source-mediation:2.6.0'
...
Modify `Podfile`
```ruby
pod 'ee-x/ad-mob-mediation', '2.6.0'
pod 'ee-x/facebook-ads', '2.6.0'
pod 'ee-x/iron-source-mediation', '2.6.0'
