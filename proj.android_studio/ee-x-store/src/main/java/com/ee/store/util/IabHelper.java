...
public class IabHelper {
        ...
        synchronized (mAsyncInProgressLock) {
            if (mAsyncInProgress) {
                throw new IabAsyncInProgressException(
                    "Can't dispose because an async operation " + "(" + mAsyncOperation +
                    ") is in progress.");
            }
        }
        logDebug("Disposing.");
    ...
    public void launchPurchaseFlow(Activity act, String sku, int requestCode,
                                   OnIabPurchaseFinishedListener listener, String extraData) throws
                                                                                             IabAsyncInProgressException {
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldSkus,
                                   ...
                                   String extraData) throws IabAsyncInProgressException {
        checkNotDisposed();
        ...
        try {
            ...
            if (oldSkus == null || oldSkus.isEmpty()) {
                ...
                buyIntentBundle =
                    mService.getBuyIntentToReplaceSkus(5, mContext.getPackageName(), oldSkus, sku,
                        itemType, extraData);
            }
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            logError(
                "Purchase failed. Result code: " + Integer.toString(resultCode) + ". Response: " +
                getResponseDesc(responseCode));
            result =
    ...
    public void queryInventoryAsync(final boolean querySkuDetails, final List<String> moreItemSkus,
                                    ...
                                    final QueryInventoryFinishedListener listener) throws
                                                                                   IabAsyncInProgressException {
    ...
    public void consumeAsync(List<Purchase> purchases,
                             OnConsumeMultiFinishedListener listener) throws
                                                                      IabAsyncInProgressException {
        checkNotDisposed();
        checkSetupDone("consume");
    ...
    int querySkuDetails(String itemType, Inventory inv, List<String> moreSkus) throws
        ...
        for (ArrayList<String> skuPartList : packs) {
            ...
            Bundle skuDetails =
                mService.getSkuDetails(3, mContext.getPackageName(), itemType, querySkus);
    ...
    void consumeAsyncInternal(final List<Purchase> purchases,
                              ...
                              final OnConsumeMultiFinishedListener multiListener) throws
                                                                                  IabAsyncInProgressException {
        final Handler handler = new Handler();
