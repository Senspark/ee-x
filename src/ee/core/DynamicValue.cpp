...
template <class T>
Self<T>& Self<T>::operator=(const Self& other) {
    set(other);
    return *this;
}
...
template <class T>
Self<T>& Self<T>::add(T amount) {
    return set(get() + amount);
}

template <class T>
Self<T>& Self<T>::subtract(T amount) {
    return set(get() - amount);
}

template <class T>
Self<T>::operator T() const {
    return get();
}

template <class T>
Self<T>& Self<T>::operator=(T value) {
    return set(value);
}
