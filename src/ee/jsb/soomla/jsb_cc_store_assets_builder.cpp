...
static se::Class* __jsb_CCStoreAssetsBuilder_class = nullptr;
static se::Class* __jsb_CCStoreAssets_class = nullptr;
} // namespace soomla
...
void set_value(se::Value& value, soomla::CCStoreAssets* input) {
    ...
    obj = se::Object::createObjectWithClass(soomla::__jsb_CCStoreAssets_class);
