...
export class IronSourceBannerAd extends ObserverManager<AdObserver> implements IBannerAd {
    ...
    public constructor(
        bridge: IMessageBridge, plugin: IronSource, adId: string, size: [number, number]) {
        super();
        this._bridge = bridge;
        this._plugin = plugin;
        this._adId = adId;
        this._messageHelper = new MessageHelper("IronSourceBannerAd", adId);
