...
namespace EE.Editor {
    internal class LibrarySettings : ScriptableObject {
        private const string LibraryVersion = "2.0.0";
        ...
        private void UpdateDependencies() {
            ...
            if (IsCoreEnabled) {
                ...
                iosLibraries.Add("ee-x/ios-core");
                if (IsAdjustEnabled) {
                    androidLibraries.Add($"com.senspark.ee:adjust:[{LibraryVersion}]");
                    iosLibraries.Add("ee-x/ios-adjust");
