...
+ (NSData *)dataFromBase64String_soomla:(NSString *)aString
{
	...
	size_t outputLength;
	void *outputBuffer = NewBase64Decode_soomla([data bytes], [data length], &outputLength);
...
- (NSString *)base64EncodedString_soomla
{
	size_t outputLength;
	char *outputBuffer =
		NewBase64Encode_soomla([self bytes], [self length], true, &outputLength);
...
- (NSString *)base64EncodedStringWithSeparateLines_soomla:(BOOL)separateLines
{
	size_t outputLength;
	char *outputBuffer =
    NewBase64Encode_soomla([self bytes], [self length], separateLines, &outputLength);
