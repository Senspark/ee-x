...
CCSoomlaStoreIosConfigBuilder::CCSoomlaStoreIosConfigBuilder()
...
CCSoomlaStoreIosConfigBuilder::activateFraudProtection(
    bool verifyOnServerFailure) {
    return (this->appendConfigParameter("SSV", cocos2d::Value(true)) &&
